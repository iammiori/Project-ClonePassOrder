//
//  SignUpPasswordConfirmController.swift
...
class SignUpPasswordConfirmController: UIViewController {

    //MARK: - 프로퍼티
    
    private let textField: UITextField =
    UITextField().signUpTextField(text: "비밀번호 한번더 입력",placeholder: "비밀번호 한번더 입력")
    ...
    private func pushNextView() {
        navigationController?.pushViewController(SignUpPhoneNumberController(), animated: true)
    }
}

//MARK: - 텍스트필드 델리게이트

extension SignUpPasswordConfirmController: UITextFieldDelegate {
